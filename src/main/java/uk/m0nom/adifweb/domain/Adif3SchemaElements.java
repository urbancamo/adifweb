...
public class Adif3SchemaElements {
    private static final Logger logger = Logger.getLogger(Adif3SchemaElements.class.getName());
    private static final String ADIF3_SCHEMA_NAME = "adx312generic.xsd";

    private Set<Adif3Element> elements;

    public Adif3SchemaElements(ResourceLoader resourceLoader) {
